...
class Test(unittest.TestCase):
    ...
    def test_create_labeled_image_positions_text_to_right_of_image_centered(self):
        ...
        self.assertEqual(50, img.get_width())
        self.assertEqual(50, img.get_height())
        
        # padding is 10
        self.assertEqual(60, txt.get_x())
        self.assertEqual(52, txt.get_y())
        self.assertEqual(50, txt.get_width())
        self.assertEqual(25, txt.get_height())
